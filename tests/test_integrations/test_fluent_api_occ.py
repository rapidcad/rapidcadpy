...
class TestFluentAPIOCCBackend:
    ...
    def test_to_png_rendering(self):
        ...
        try:
            ...
            shape.to_png("test_render_x.png", "X", backend="pyribbit")  # Right view
            shape.to_png("test_render_y.png", "Y", backend="pyribbit")  # Front view
            shape.to_png("test_render_z.png", "Z", backend="pyribbit")  # Top view
            
            # Verify at least one output file was created for each view
            # (either PNG if cairosvg is available, or SVG as fallback)
            assert (
                os.path.exists("test_render_x.png") or os.path.exists("test_render_x.svg")
            ), "X view output file should exist"
            assert (
                os.path.exists("test_render_y.png") or os.path.exists("test_render_y.svg")
            ), "Y view output file should exist"
            assert (
                os.path.exists("test_render_z.png") or os.path.exists("test_render_z.svg")
    ...
    def test_to_png_cube(self):
        ...
        try:
            ...
            assert (
                os.path.exists(test_file) or os.path.exists(fallback_file)
