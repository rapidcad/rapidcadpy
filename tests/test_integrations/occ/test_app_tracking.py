...
class TestShow3D:
    ...
    def test_show_3d_complex_geometry(self, app, tmp_path):
        ...
        truss_member = (
            wp.move_to(0, 0)
            .line_to(truss_width, 0)
            .line_to(truss_width, truss_height)
            .line_to(0, truss_height)
            .close()
    ...
    def test_show_3d_multiple_shapes_different_colors(self, app, tmp_path):
        ...
        app.show_3d(screenshot=str(output_file), shape_opacity=0.8)
        assert output_file.exists()
