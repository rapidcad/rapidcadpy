...
wp1.move_to(0.0, 0.0).line_to(0.0, 2.5).line_to(2.265, 2.5).line_to(
    2.265, 3.15
...
wp2.move_to(0.45, 2.35).line_to(0.665, 2.35).line_to(0.665, 2.5).line_to(
    0.45, 2.5
).line_to(0.45, 2.35)
...
wp4.move_to(0.0, 0.0).line_to(0.0, 0.8).line_to(0.155885, 0.53).line_to(
    0.640859, 0.25
).line_to(1.055662, 0.25).line_to(1.2, 0.0).line_to(0.0, 0.0)
...
wp5.move_to(5.88, 2.35).line_to(5.665, 2.35).line_to(5.665, 2.5).line_to(
    5.88, 2.5
).line_to(5.88, 2.35)
...
wp6.move_to(4.065, 2.7).line_to(4.045, 2.625359).three_point_arc(
    (4.069475, 2.492195), (4.203038, 2.47)
).line_to(4.315, 2.5).line_to(4.315, 2.7).line_to(4.065, 2.7)
...
wp7.move_to(6.33, 2.3).line_to(6.31, 2.225359).three_point_arc(
    (6.334475, 2.092195), (6.468038, 2.07)
).line_to(6.58, 2.1).line_to(6.58, 2.3).line_to(6.33, 2.3)
...
wp8.move_to(8.93, -0.4).line_to(13.13, -0.4).three_point_arc(
    (13.53, 0.0), (13.13, 0.4)
).line_to(8.93, 0.4).three_point_arc((8.53, 0.0), (8.93, -0.4))
...
wp9.move_to(7.93, 1.5).line_to(7.91, 1.425359).three_point_arc(
    (7.934475, 1.292195), (8.068038, 1.27)
).line_to(8.18, 1.3).line_to(8.18, 1.5).line_to(7.93, 1.5)
