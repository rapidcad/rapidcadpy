...
wp1.move_to(0.0, 0.0).line_to(0.0, 1.6).line_to(9.3, 1.6).line_to(9.3, 2.25).line_to(10.9, 2.25).line_to(10.9, 2.75).line_to(13.365, 2.75).line_to(13.365, 3.5).line_to(15.165, 3.5).line_to(15.165, 2.75).line_to(19.43, 2.75).line_to(19.43, 2.1).line_to(28.53, 2.1).line_to(28.53, 0.0).line_to(0.0, 0.0)
...
wp2.move_to(1.15, -0.5).line_to(8.15, -0.5).three_point_arc((8.65, 0.0), (8.15, 0.5)).line_to(1.15, 0.5).three_point_arc((0.65, 0.0), (1.15, -0.5))
...
wp4.move_to(0.0, 0.0).line_to(0.0, 0.5).line_to(0.095263, 0.335).line_to(0.402702, 0.1575).line_to(1.009067, 0.1575).line_to(1.1, 0.0).line_to(0.0, 0.0)
...
wp5.move_to(10.761962, 2.22).line_to(10.65, 2.25).line_to(10.65, 2.45).line_to(10.9, 2.45)
...
wp6.move_to(11.35, 2.6).line_to(11.565, 2.6).line_to(11.565, 2.75).line_to(11.35, 2.75).line_to(11.35, 2.6)
...
wp7.move_to(13.226962, 2.72).line_to(13.115, 2.75).line_to(13.115, 2.95).line_to(13.365, 2.95)
...
wp8.move_to(15.165, 2.95).line_to(15.145, 2.875359).three_point_arc((15.169475, 2.742195), (15.303038, 2.72)).line_to(15.415, 2.75).line_to(15.415, 2.95).line_to(15.165, 2.95)
...
wp9.move_to(18.43, -0.4).line_to(19.43, -0.4).three_point_arc((19.83, 0.0), (19.43, 0.4)).line_to(18.43, 0.4).three_point_arc((18.03, 0.0), (18.43, -0.4))
...
wp10.move_to(21.08, -0.6).line_to(26.88, -0.6).three_point_arc((27.48, 0.0), (26.88, 0.6)).line_to(21.08, 0.6).three_point_arc((20.48, 0.0), (21.08, -0.6))
...
wp11.move_to(19.43, 2.3).line_to(19.41, 2.225359).three_point_arc((19.434475, 2.092195), (19.568038, 2.07)).line_to(19.68, 2.1).line_to(19.68, 2.3).line_to(19.43, 2.3)
