...
wp1.move_to(0.0, 0.0).line_to(0.0, 1.6).line_to(8.4, 1.6).line_to(8.4, 2.25).line_to(
    10.0, 2.25
).line_to(10.0, 2.75).line_to(12.465, 2.75).line_to(12.465, 3.25).line_to(
    14.265, 3.25
).line_to(14.265, 2.75).line_to(16.73, 2.75).line_to(16.73, 0.0).line_to(0.0, 0.0)
...
wp2.move_to(1.2, -0.5).line_to(7.2, -0.5).three_point_arc(
    (7.7, 0.0), (7.2, 0.5)
).line_to(1.2, 0.5).three_point_arc((0.7, 0.0), (1.2, -0.5))
...
wp5.move_to(10.45, 2.6).line_to(10.665, 2.6).line_to(10.665, 2.75).line_to(
    10.45, 2.75
).line_to(10.45, 2.6)
...
wp6.move_to(12.326962, 2.72).line_to(12.215, 2.75).line_to(12.215, 2.95).line_to(
    12.465, 2.95
)
...
wp7.move_to(16.28, 2.6).line_to(16.065, 2.6).line_to(16.065, 2.75).line_to(
    16.28, 2.75
).line_to(16.28, 2.6)
...
wp8.move_to(14.265, 2.95).line_to(14.245, 2.875359).three_point_arc(
    (14.269475, 2.742195), (14.403038, 2.72)
).line_to(14.515, 2.75).line_to(14.515, 2.95).line_to(14.265, 2.95)
