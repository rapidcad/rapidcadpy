...
def app():
    try:
        ...
        try:
            ...
            pytest.skip("No suitable CAD library found.")
...
def test_show_3d_with_shapes_only(app):
...
def test_show_3d_with_sketches(app):
    ...
    pending_count = sum(
        1 for wp in workplanes if hasattr(wp, "_pending_shapes") and wp._pending_shapes
    )
