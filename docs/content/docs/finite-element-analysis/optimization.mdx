...
>
  ...
  <PythonFunction
    ...
    signature="get_visualization_data(shape, material, loads, constraints, mesh_size, element_type)"
    description="Prepare mesh and boundary condition data for visualization without solving. Used internally by FEAAnalyzer.show()."
    params={{
      shape: {
        type: 'Shape',
        description: 'Shape to visualize',
        required: true,
      },
      material: {
        type: 'MaterialProperties',
      ...
      loads: {
        type: 'List[Load]',
        description: 'List of loads to visualize',
        required: true,
      },
      constraints: {
        type: 'List[BoundaryCondition]',
        description: 'List of constraints to visualize',
        required: true,
      },
      mesh_size: {
        type: 'float',
    ...
    returns="Tuple of (pv_mesh, nodes, constraint_mask, force_mask, force_vectors) for visualization"
    returnType="Tuple[UnstructuredGrid, ndarray, ndarray, ndarray, ndarray]"
  />
